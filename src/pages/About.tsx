...
export default function About() {
    return (
        <div className="flex items-center w-full px-[10%] justify-center h-full">
            <Helmet>
                <title>Bo | About</title>
            </Helmet>
            <div className="flex-1 xl:relative xl:bottom-auto xl:place-content-center text-justify flex flex-col gap-4">
                <div className="text-[4em] font-bold mx-0 animate-fade-in fill-mode-both">What's Poppin!</div>
                <div className="text-[1.2em] text-grey mx-0 animate-fade-in fill-mode-both animation-delay-200">
                ...
                <div className="text-[1.2em] text-grey mx-0 animate-fade-in fill-mode-both animation-delay-400">
                ...
                <div className="pt-2 w-full flex flex-row items-center gap-4 h-full animate-fade-in animation-delay-600 fill-mode-both">
