    ...
    return (
        <div>
            ...
            <div className="py-20 w-full flex flex-col items-center">
                ...
                <div className="text-2xl text-grey opacity-70 text-center mt-2 animate-fade-in fill-mode-both animation-delay-200 px-40">Here are some of my favorite projects I've worked on.</div>
